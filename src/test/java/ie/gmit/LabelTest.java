...
public class LabelTest {
    ...
    @Test
    void testGenerateLabel() throws JsonProcessingException {
    ...
    @Test
    void testGetSetID() throws JsonProcessingException {
        myCustomer = new Customer(888888, "john", "green", "johngreen@gmail.com", "47 Farrow Road", "Kerry", "T67 K9R5");
        myLabel = new Label(myCustomer);
    ...
    @Test
    void testGetSetOrderIDList() throws JsonProcessingException {
